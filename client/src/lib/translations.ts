...
export const translations: Record<Language, TranslationMap> = {
  ...
  de: {
    ...
    pastDateSelected: "Bitte wähle ein Datum in der Zukunft – Reservierungen in der Vergangenheit sind leider nicht möglich.",
  ...
  en: {
    ...
    pastDateSelected: "Please select a date in the future - reservations in the past are not possible.",
